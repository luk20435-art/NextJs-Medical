        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <h3 className="text-3xl font-bold text-gray-900 mb-2">รายละเอียดของกายวิภาคศาสตร์จุลภาค</h3>
                    <p className="text-xl text-gray-600">Microscopic Anatomy</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {topics.map((topic, index) => {
                        ...
                        >
                            ...
                            <CardContent>
                                {/* เพิ่มเนื้อหาเพิ่มเติมได้ที่นี่ */}
                            </CardContent>
                            </Card>
                        </motion.div>
                        )
